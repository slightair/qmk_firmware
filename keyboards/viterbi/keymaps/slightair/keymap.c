 ...
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * | Pg Up| Shift|   Z  |   X  |   C  |   V  |   B  |      |   N  |   M  |   ,  |   .  |   /  |   \  |   =  |
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * | Pg Dn|Adjust| Alt  | GUI  | Home |Lower |Space |      |Space |Raise | End  | Left | Down |  Up  | Right|
 * `------------------------------------------------'      `------------------------------------------------'
 */
  [_QWERTY] = KC_KEYMAP(
  //,----+----+----+----+----+----+----.    ,----+----+----+----+----+----+----.
  ...
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     PGUP,LSFT, Z  , X  , C  , V  , B  ,      N  , M  ,COMM,DOT ,SLSH,BSLS,EQL ,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     PGDN,AJST,LALT,LGUI,HOME,LOWR,SPC ,     SPC ,RASE, END,LEFT,DOWN, UP ,RGHT
  //`----+----+----+----+----+----+----'    `----+----+----+----+----+----+----'
  ),
 ...
 */
  ...
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     PLUS,    , F1 , F2 , F3 , F4 , F5 ,     LEFT,DOWN, UP ,RGHT,    ,    ,    ,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
         ,    , F7 , F8 , F9 ,F10 ,F11 ,     F12 ,    ,    ,MPRV,    ,    ,    ,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
         ,    ,    ,    ,    ,    ,    ,         ,    ,MUTE,MNXT,VOLD,VOLU,MPLY
  //`----+----+----+----+----+----+----'    `----+----+----+----+----+----+----'
  ),
 ...
 * |   +  |      |  F1  |  F2  |  F3  |  F4  |  F5  |      |  F6  |   -  |   =  |   [  |   ]  |      |      |
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * |      |      |  F7  |  F8  |  F9  |  F10 |  F11 |      |  F12 |ISO # |ISO / | Prev |      |      |      |
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      |      | Mute | Next | Vol- | Vol+ | Play |
 * `------------------------------------------------'      `------------------------------------------------'
 */
  ...
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
         ,    , F7 , F8 , F9 ,F10 ,F11 ,     F12 ,NUHS,NUBS,MPRV,    ,    ,    ,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
         ,    ,    ,    ,    ,    ,    ,         ,    ,MUTE,MNXT,VOLD,VOLU,MPLY
  //`----+----+----+----+----+----+----'    `----+----+----+----+----+----+----'
  ),
