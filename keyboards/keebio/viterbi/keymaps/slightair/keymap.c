...
/* QWERTY [
 * ,------------------------------------------------.      ,------------------------------------------------.
 * | SLCK |      |   1  |   2  |   3  |   4  |   5  |      |   6  |   7  |   8  |   9  |   0  | HOME | PSCR  |
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 ...
 * |      | Shift|   Z  |   X  |   C  |   V  |   B  |      |   N  |   M  |   ,  |   .  |   /  |   -  |   =  |
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * |Adjust| Esc  | Alt  | GUI  | Shift|Lower |Space |      |Enter |Raise | Shift| Left | Down |  Up  | Right|
 * `------------------------------------------------'      `------------------------------------------------'
 */
  [_QWERTY] = LAYOUT_kc(
  //,----+----+----+----+----+----+----.    ,----+----+----+----+----+----+----.
  ...
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     AJST,ESC ,LALT,LGUI,LSFT,LOWR,SPC ,     ENT ,RASE,RSFT,LEFT,DOWN, UP ,RGHT
  //`----+----+----+----+----+----+----'    `----+----+----+----+----+----+----'
  ),
 ...
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * |   ~  |      |  F1  |  F2  |  F3  |  F4  |  F5  |      |   7  |   8  |   9  |   0  |   =  |   (  |   )  |
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * |      |      |  F6  |  F7  |  F8  |  F9  |  F10 |      |   4  |   5  |   6  |   -  |   /  |   [  |   ]  |
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * |      |      |  F11 |  F12 |      |      |      |      |   1  |   2  |   3  |   +  |   *  |      |      |
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |   0  |      | Prev | Next | Vol- | Vol+ | Play |
 * `------------------------------------------------'      `------------------------------------------------'
 */
  [_LOWER] = LAYOUT_kc(
  //,----+----+----+----+----+----+----.    ,----+----+----+----+----+----+----.
         ,    , F1 , F2 , F3 , F4 , F5 ,      F6 , F7 , F8 , F9 ,F10 ,F11 ,F12 ,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     TILD,    , F1 , F2 , F3 , F4 , F5,        7 ,  8 ,  9 , 0  , EQL,LPRN,RPRN,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
         ,    , F6 , F7 , F8 , F9 ,F10 ,       4 ,  5 ,  6 ,MINS,SLSH,LBRC,RBRC,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
         ,    , F11, F12,    ,    ,    ,       1 ,  2 ,  3 ,PLUS,ASTR,    ,    ,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
         ,    ,    ,    ,    ,    ,    ,       0 ,    ,MPRV,MNXT,VOLD,VOLU,MPLY
  //`----+----+----+----+----+----+----'    `----+----+----+----+----+----+----'
  ),
 ...
 */
  ...
  //,----+----+----+----+----+----+----.    ,----+----+----+----+----+----+----.
         ,    , F1 , F2 , F3 , F4 , F5 ,      F6 , F7 , F8 , F9 ,F10 ,F11 ,F12 ,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     TILD,    ,EXLM, AT ,HASH,DLR ,PERC,     CIRC,AMPR,ASTR,MINS,PLUS,LCBR,RCBR,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
